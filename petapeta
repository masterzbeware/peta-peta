...
do
  ...
  function library.new(title)
    ...
    local handle = main:WaitForChild("ResizeHandle")
    ...
    handle.InputBegan:Connect(function(inp)
      if inp.UserInputType == Enum.UserInputType.MouseButton1 then
        ...
        startMouse = input:GetMouseLocation()
      end
    end)
    ...
    input.InputChanged:Connect(function(inp)
      if resizing and inp.UserInputType == Enum.UserInputType.MouseMovement then
        ...
        local newWidth = math.clamp(startSize.X + delta.X, 300, 1000)
	...
	function library:toggle()
        ...
        Position = self.position + UDim2.new(0, 0, container.Size.Y.Scale, container.Size.Y.Offset)
			}, 0.2)
			wait(0.2)
		end
